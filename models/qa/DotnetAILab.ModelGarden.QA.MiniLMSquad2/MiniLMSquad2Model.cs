...
namespace DotnetAILab.ModelGarden.QA.MiniLMSquad2;

/// <summary>
/// Model package for MiniLM uncased Squad2 question answering.
/// Downloads ONNX model on first use, caches locally.
/// </summary>
public static class MiniLMSquad2Model
{
    private static readonly Lazy<ModelPackage> Package = new(() =>
        ModelPackage.FromManifestResource(typeof(MiniLMSquad2Model).Assembly));
