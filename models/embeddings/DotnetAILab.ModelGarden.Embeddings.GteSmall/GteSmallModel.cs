...
namespace DotnetAILab.ModelGarden.Embeddings.GteSmall;

/// <summary>
/// Model package for gte-small.
/// Downloads ONNX model on first use, caches locally.
/// </summary>
public static class GteSmallModel
{
    private static readonly Lazy<ModelPackage> Package = new(() =>
        ModelPackage.FromManifestResource(typeof(GteSmallModel).Assembly));
